...
class DD_GAT(nn.Module):
    ...
    def __init__(
        ...
        if not use_vae:
            ...
            self.recon_model = ReconstructionVAE(window_size, gru_hid_dim, recon_hid_dim, out_dim, recon_n_layers, dropout)
    ...
    def forward(self, x):
        ...
        if not self.use_vae:
            ...
            return predictions, recons, None, None
        else:
            recons, mu, logvar = self.recon_model(h_end)
            return predictions, recons,mu, logvar
